...
namespace Code.Gameplay.Character.Framework
{
    ...
    public class LatitudeHandler : IRequest<float>, ICommand<float>
    {
        private Transform obj;

        public LatitudeHandler(Transform obj)
        {
            this.obj = obj;
        }
    ...
    public class RotationHandler : IRequest<Quaternion>, ICommand<Quaternion>
    {
        private Transform obj;
